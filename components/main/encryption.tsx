          ...
          <div className="flex flex-col gap-2 p-5 bg-[#0a0a1f]/50 rounded-xl border border-purple-500/30">
            ...
            <ul className="list-none text-gray-300 space-y-2.5 mt-3">
              <li className="flex items-start gap-2">
                ...
                <span>Delivered software support for <span className="text-cyan-400 font-semibold">many clients</span>, achieving <span className="text-cyan-400 font-semibold">~95% first-contact resolution</span></span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-400 mt-1">▹</span>
